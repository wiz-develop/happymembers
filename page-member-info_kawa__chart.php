...
get_header();
session_check();?>
<script src="<?php echo get_stylesheet_directory_uri();?>/assets/js/chart_kawa.js"></script>
<?php
                ...
                <div class="chart">
                    <div class="chart__search">
                        ...
                        <div class="chart__search__select">
                            ...
                            <div class="chart__search__select__branch ex-binary" style="display:none;">
                    ...
                    <div class="chart__content">
                        <?php if ($happy_id) :?>
                            ...
                            <label class="tab_class list-tab ei-tab" for="introducer-happy">ハッピー紹介者</label>
                            <div class="content_class content_introducer-happy">
                                <div class="chart_scroll_target" data-base-width="">
                        ...
                        <?php if ($excellent_id) :?>
                            ...
                            <label class="tab_class list-tab ei-tab" for="introducer-excellent">エクセレント紹介者</label>
                            ...
                            <label class="tab_class list-tab ei-tab" for="excellent-binary">エクセレントバイナリ</label>
                            <div class="content_class content_excellent-binary">
                                <div class="chart_scroll_target" data-base-width="">
                                    <div class="chart__base-box ex-binary" id="base-box-binary" style="left: 50%; top: 5%;"  data-type="ex" data-member_type="1" position="relative">
                                        <div class="chart__base-box__inner ex-binary you" style="left: 0px; top: 0px;" id="ex-bi-<?php echo $_SESSION['info']['ex']["mbr_id"].'001';?>">
                                            <div class="modal_trigger chart-user">
                                                <div class="modal_trigger__member-img chart-user__icon">
                                                    <img class="img-mbr" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/chart/you-icon.png">
                                                </div>
                        ...
                        <?php endif;?>
<div id="test1" style="width: 100000px;"></div>
                        <!-- モーダル -->
                        <div class="modal_box">
